...
public class PHCategoryValidations extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void PHCategoryWithLessThan40Percentage() throws Exception {

		// logger = report.createTest("PH Category With Less Than 40 Percent
		// Disability");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PH Category With Less Than 40 Percent Disability scenario");

	}

	@Test(priority = 2)
	public void PHCategoryWithMoreThan100Percentage() throws Exception {

		// logger = report.createTest("PH Category With More Than 100 Percent
		// Disability");
		...
		ExtentFactory.getInstance().getExtent().info(
				"Successfully Checked PH Category With More Than 100 Percent Disability scenario");

	}

	@Test(priority = 3)
	public void PHCategoryBetween40To100Percentage() throws Exception {

		// logger = report.createTest("PH Category Between 40 To 100 Percentage
		// Disability");
		...
		Form.DisabilityType(DisabilityTypeB);
		Thread.sleep(600);
		ExtentFactory.getInstance().getExtent().info("Inputting Between 40 to 100 Percentage Disability");
		Thread.sleep(600);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PH Category Between 40 To 100 Percentage Disability scenario");
