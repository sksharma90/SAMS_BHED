...
public class MarksComparison extends BaseClass implements BHEdData {
	...
	public void ObtainedMarkIslessthanMaxMark() throws Exception {
		...
		// logger = report.createTest("Obtained Mark Is less than MaxMark");
	...
	public void ObtainedMarkIsEqualToMaxMark() throws Exception {
		...
		Form.TenthObtainedMark().sendKeys(TenthSecuredMarkEQ);
		Thread.sleep(1000);
		Form.TwelthExamPassed(TwelthExamName);
		Thread.sleep(1000);
		Form.TwelthBoard(TwelthBoardName);
	...
	public void ObtainedMarkIsGreaterThanMaxMark() throws Exception {
		...
		Form.TenthObtainedMark().sendKeys(TenthSecuredMarkG);
		Thread.sleep(1000);
		Form.Submit().click();
		...
		Thread.sleep(600);
		ExtentFactory.getInstance().getExtent().info("Assertion of Expected & Actual Result");
		if (msg.equals("Maximum Mark/CGPA cannot be less than mark/CGPA obtained")) {
			System.out.println(msg);
	...
	public void TwelthMaximumMarkcannotbelessthanMarkObtained() throws Exception {
		...
		// logger = report.createTest("Twelth Maximum Mark cannot be less than Mark
		// Obtained");
		...
		Form.TwelthObtainedMark().sendKeys(TwelthSecuredMarkG);
	...
	@Test(priority = 5)
	public void GraduationMaximumMarkcannotbelessthanMarkObtained() throws Exception {

		// logger = report.createTest("Graduation Maximum Mark cannot be less than Mark
		// Obtained");
	...
	@Test(priority = 5)
	public void PGMaximumMarkcannotbelessthanMarkObtained() throws Exception {

		// logger = report.createTest("PG Maximum Mark cannot be less than Mark
		// Obtained");
