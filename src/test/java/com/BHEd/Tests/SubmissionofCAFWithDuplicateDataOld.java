...
public class SubmissionofCAFWithDuplicateDataOld extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void SubmissionWithDuplicateRollNo() throws Exception {

		// logger = report.createTest("Non Acceptance of Duplicate Roll No");
		...
		ExtentFactory.getInstance().getExtent().info("Entering Duplicate Roll No");
		...
		softAssert.assertEquals(msg, "Duplicate 10th Roll No. Found which is already submitted by another applicant!");

		softAssert.assertAll();

		ExtentFactory.getInstance().getExtent().info("Successfully Checked Non Acceptance of Duplicate Roll No");
