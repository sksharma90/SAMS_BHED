...
public class AgeCriteriaForFemaleApplicants extends BaseClass implements BHEdData {
	...
	public void FemaleApplicantBornBeforeAgeAsOn() throws Exception {
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For Female Applicant");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked Female Applicant Born Before Age As On Scenario");

	}

	@Test(priority = 2)
	public void PWDFemaleApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("PWD Female Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For PWD Female Applicant");
		Form.PWDFemaleBornBefore();
		Thread.sleep(1000);
		ExtentFactory.getInstance().getExtent().info("Selecting Reserve Category as PH");
		Form.ReserveCategory(ReserveCategoryPH);
		Thread.sleep(1000);
		Form.SocialCategory(SocialCategoryS);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD Female Applicant Born Before Age As On Scenario");

	}

	@Test(priority = 3)
	public void FemaleApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("Female Applicant Born On Age As On");
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked Unreserved Female Applicant Born On Age As On Scenario");

	}

	@Test(priority = 4)
	public void PWDFemaleApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("PWD Female Applicant Born On Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked Female Applicant Born On Age As On");

	}

	@Test(priority = 5)
	public void FemaleApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("Female Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For Female Applicant");
		Form.FemaleBornAfter();
		Thread.sleep(1000);
		Form.AadhaarNumber().clear();
		Form.AadhaarNumber().sendKeys(AadhaarNo);
		Thread.sleep(1000);
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked Female Applicant Born After Age As On scenario");

	}

	@Test(priority = 6)
	public void PWDFemaleApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("PWD Female Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For PWD Female Applicant");
		Form.PWDFemaleBornAfter();
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD Female Applicant Born After Age As On Scenario");
