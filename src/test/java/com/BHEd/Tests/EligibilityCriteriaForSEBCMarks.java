...
public class EligibilityCriteriaForSEBCMarks extends BaseClass implements BHEdData {
	...
	public void HindiHonoursPassElectiveWithMoreThan45Percentage() throws Exception {
		...
		Thread.sleep(1000);
		ExtentFactory.getInstance().getExtent().info("Selecting Social Category as SEBC");
