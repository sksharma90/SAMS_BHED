...
public class AadhaarValidations extends BaseClass implements BHEdData {
...
//		Form.ReserveCategory(ReserveCategoryS);
	...
	@Test(priority = 3)
	public void AcceptanceofDuplicateAadhaar() throws Exception {
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked Acceptance of Duplicate Aadhaar scenario");
