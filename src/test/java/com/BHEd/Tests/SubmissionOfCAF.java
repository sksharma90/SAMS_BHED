...
public class SubmissionOfCAF extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void SuccessfulSubmissionofCAF() throws Exception {

		//logger = report.createTest("Successful submission of CAF by Fresh Applicant");
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked Submission By Fresh Applicant scenario");
