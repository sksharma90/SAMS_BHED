...
public class AgeCriteriaForSTApplicants extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void STApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("ST Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For ST Applicant");
		Form.SCSTBornBefore();
		Thread.sleep(1000);
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked ST Applicant Born Before Age As On");

	}

	@Test(priority = 2)
	public void PWDSTApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("PWD ST Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD ST Applicant Born Before Age As On Scenario");

	}

	@Test(priority = 3)
	public void STApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("ST Applicant Born On Age As On");
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked ST Applicant Born On Age As On");

	}

	@Test(priority = 4)
	public void PWDSTApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("PWD ST Applicant Born On Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For PWD ST Applicant");
		Form.PWDSCSTBornOn();
	...
	@Test(priority = 5)
	public void STApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("ST Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For ST Applicant");
		Form.SCSTBornAfter();
		Thread.sleep(1000);
		Form.AadhaarNumber().clear();
		Form.AadhaarNumber().sendKeys(AadhaarNo);
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked ST Applicant Born After Age As On scenario");

	}

	@Test(priority = 6)
	public void PWDSTApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("PWD ST Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For PWD ST Applicant");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD ST Applicant Born After Age As On Scenario");
