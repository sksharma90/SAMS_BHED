...
public class YOPComparisons12thGraduation extends BaseClass implements BHEdData {
	...
	public void YOPBetween12thAndGraduationWithValidData() throws Exception {
		...
		// logger = report.createTest("YOP Between 12th And Graduation with valid
		// data");
	...
	public void YOPBetween12thAndGraduationWithIdenticalData() throws Exception {
		...
		// logger = report.createTest("YOP Between 12th And Graduation With Identical
		// Data");
		...
		Thread.sleep(600);
		ExtentFactory.getInstance().getExtent().info("Assertion of Expected & Actual Result");
		if (msg.equals("Graduation Year Of Passing should be 3 years after +2/12th/equivalent Year Of Passing")) {
			System.out.println(msg);
			Form.JavaDismissAlert();
		...
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertEquals(msg, "Graduation Year Of Passing should be 3 years after +2/12th/equivalent Year Of Passing");
	...
	public void YOPBetween12thAndGraduationWithInvalidData() throws Exception {
		...
		// logger = report.createTest("YOP Between 12th And Graduation With Invalid
		// Data");
	...
	public void YOPBetween12thAndGraduationWithDiffLessThan3years() throws Exception {
		...
		// logger = report.createTest("YOP Between 12th And Graduation With Difference
		// less than 3 years");
