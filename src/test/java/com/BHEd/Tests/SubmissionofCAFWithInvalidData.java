...
public class SubmissionofCAFWithInvalidData extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void SubmissionWithInvalidData() throws Exception {

		// logger = report.createTest("Submission of CAF With Invalid Data");
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked Submission With Invalid Data scenario");
