...
public class ApplyingCAFWithDiffernetExamType extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void ApplyingCAFWithAnnualExamType() throws Exception {

		// logger = report.createTest("Verifying Submission of CAF by Annual Examination
		// passed Applicants");
	...
	@Test(priority = 2)
	public void ApplyingCAFWithSupplementaryExamType() throws Exception {

		// logger = report.createTest("Verifying Submission of CAF by Supplementary
		...
		Form.TenthYOP(TenthYOP);
		Thread.sleep(1000);
		ExtentFactory.getInstance().getExtent().info("Selecting Exam Type as Supplementary");
		Form.Supplementary().click();
		Thread.sleep(1000);
		Form.GraduationPassed().click();
		Thread.sleep(1000);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully checked submission by Supplementary Exam Type scenario");
	}
