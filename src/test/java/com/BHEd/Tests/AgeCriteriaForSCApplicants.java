...
public class AgeCriteriaForSCApplicants extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void SCApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("SC Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For SC Applicant");
		Form.SCSTBornBefore();
		Thread.sleep(1000);
		...
		if (msg.equals("Date Of Birth Should be On or  After 31-Aug-1988")) {
		...
		softAssert.assertEquals(msg, "Date Of Birth Should be On or  After 31-Aug-1988");

		softAssert.assertAll();

		ExtentFactory.getInstance().getExtent().info("Successfully Checked SC Applicant Born Before Age As On");

	}

	@Test(priority = 2)
	public void PWDSCApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("PWD SC Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD SC Applicant Born Before Age As On Scenario");

	}

	@Test(priority = 3)
	public void SCApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("SC Applicant Born On Age As On");
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked SC Applicant Born On Age As On");

	}

	@Test(priority = 4)
	public void PWDSCApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("PWD SC Applicant Born On Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For PWD SC Applicant");
		Form.PWDSCSTBornOn();
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked SC Applicant Born On Age As On scenario");

	}

	@Test(priority = 5)
	public void SCApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("SC Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For SC Applicant");
		Form.SCSTBornAfter();
		Thread.sleep(1000);
		Form.AadhaarNumber().clear();
		Form.AadhaarNumber().sendKeys(AadhaarNo);
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked SC Applicant Born After Age As On scenario");

	}

	@Test(priority = 6)
	public void PWDSCApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("PWD SC Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For PWD SC Applicant");
		Form.PWDSCSTBornAfter();
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD SC Applicant Born After Age As On Scenario");
