...
public class MobileNoComparison extends BaseClass implements BHEdData {
	...
	public void DifferentRegisteredMobileNoAlternateMobileNo() throws Exception {
		...
		// logger = report.createTest("Different Registered Mobile No & Alternate Mobile
		// No");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Entering different Mobile no than Registered Mob No. in Alt.Mobile No.");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked Different Registered MobileNo & Alternate MobileNo Scenario");
	...
	public void IdenticalRegisteredMobileNoAlternateMobileNo() throws Exception {
		...
		// logger = report.createTest("Identical Registered MobileNo & Alternate
		// MobileNo");
		...
		Form.ValidDateOfBirth();
		Thread.sleep(1000);
		ExtentFactory.getInstance().getExtent().info("Enter Identical Registered MobileNo & Alternate MobileNo");
		Form.AlternateMobileNumber().clear();
		Form.AlternateMobileNumber().sendKeys(MobileNumber);
		Thread.sleep(1000);
		...
		Thread.sleep(600);
		ExtentFactory.getInstance().getExtent().info("Assertion of Expected & Actual Result");
		if (msg.equals("Mobile no. and Alternate mobile no. cannot be same!")) {
			System.out.println(msg);
		...
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertEquals(msg, "Mobile no. and Alternate mobile no. cannot be same!");

		softAssert.assertAll();

		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked Non-Acceptance of Identical MobileNo & AltMobileNo");
	...
	public void AcceptanceofDuplicateAlternateMobileNo() throws Exception {
		...
		// logger = report.createTest("Acceptance of Duplicate Alternate Mobile No");
		...
		Form.ValidDateOfBirth();
		Thread.sleep(1000);
		ExtentFactory.getInstance().getExtent().info("Entering Duplicate Alternate MobileNo");
		Form.AlternateMobileNumber().clear();
		Form.AlternateMobileNumber().sendKeys(AlternateMobNo);
		Thread.sleep(1000);
		Form.AadhaarNumber().clear();
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked Acceptance of Duplicate Alternate MobileNo");
