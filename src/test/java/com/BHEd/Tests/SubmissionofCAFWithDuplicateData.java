...
public class SubmissionofCAFWithDuplicateData extends BaseClass implements BHEdData {
	...
	public void SubmissionWithDuplicateRollNo() throws Exception {
		...
		ExtentFactory.getInstance().getExtent().info("Successfully Checked Acceptance of Duplicate Roll No");
