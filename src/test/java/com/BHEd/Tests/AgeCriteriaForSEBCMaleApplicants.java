...
public class AgeCriteriaForSEBCMaleApplicants extends BaseClass implements BHEdData {
	...
	@Test(priority = 1)
	public void SEBCApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("SEBC Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For SEBC Applicant");
		Form.SEBCMaleBornBefore();
		Thread.sleep(1000);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked SEBC Applicant Born Before Age As On Scenario");

	}

	@Test(priority = 2)
	public void PWDSEBCApplicantBornBeforeAgeAsOn() throws Exception {

		// logger = report.createTest("PWD SEBC Applicant Born Before Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For PWD SEBC Applicant");
		Form.PWDSEBCMaleBornBefore();
		Thread.sleep(1000);
	...
	@Test(priority = 3)
	public void SEBCApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("SEBC Male Applicant Born On Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For SEBC Male Applicant");
		Form.SEBCMaleBornOn();
		Thread.sleep(1000);
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked SEBC Male Applicant Born On Age As On Scenario");

	}

	@Test(priority = 4)
	public void PWDSEBCApplicantBornOnAgeAsOn() throws Exception {

		// logger = report.createTest("PWD SEBC Applicant Born On Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB Before Valid Date For SEBC PWD Male Applicant");
		Form.PWDSEBCMaleBornOn();
	...
	@Test(priority = 5)
	public void SEBCApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("SEBC Male Applicant Born On After Age As On");
		...
		ExtentFactory.getInstance().getExtent().info("Selecting DOB After Valid Date For SEBC Male Applicant");
		Form.SEBCMaleBornAfter();
		Thread.sleep(1000);
		Form.AadhaarNumber().clear();
		Form.AadhaarNumber().sendKeys(AadhaarNo);
		Thread.sleep(1000);
...
//		Form.ReserveCategory(ReserveCategoryS);
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked SEBC Male Applicant Born On After Age As On scenario");

	}

	@Test(priority = 6)
	public void PWDSEBCApplicantBornAfterAgeAsOn() throws Exception {

		// logger = report.createTest("PWD SEBC Applicant Born After Age As On");
		...
		ExtentFactory.getInstance().getExtent()
				.info("Successfully Checked PWD SEBC Applicant Born After Age As On Scenario");
